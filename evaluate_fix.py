...
if __name__ == '__main__':
	...
	for network in args.network:
		...
		conv1_bias = model_dict['conv1.bias']
		bn1_weight = model_dict['bn1.weight']
		bn1_bias = model_dict['bn1.bias']
		bn1_running_mean = model_dict['bn1.running_mean']
		bn1_running_var = model_dict['bn1.running_var']

		conv2_weight = model_dict['conv2.weight']
		conv2_bias = model_dict['conv2.bias']
		bn2_weight = model_dict['bn2.weight']
		bn2_bias = model_dict['bn2.bias']
		bn2_running_mean = model_dict['bn2.running_mean']
		bn2_running_var = model_dict['bn2.running_var']

		conv3_weight = model_dict['conv3.weight']
		conv3_bias = model_dict['conv3.bias']
		bn3_weight = model_dict['bn3.weight']
		bn3_bias = model_dict['bn3.bias']
		bn3_running_mean = model_dict['bn3.running_mean']
		bn3_running_var = model_dict['bn3.running_var']

		res1_conv1_weight = model_dict['res1.conv1.weight']
		res1_conv1_bias = model_dict['res1.conv1.bias']
		res1_bn1_weight = model_dict['res1.bn1.weight']
		res1_bn1_bias = model_dict['res1.bn1.bias']
		res1_bn1_running_mean = model_dict['res1.bn1.running_mean']
		res1_bn1_running_var = model_dict['res1.bn1.running_var']
		res1_conv2_weight = model_dict['res1.conv2.weight']
		res1_conv2_bias = model_dict['res1.conv2.bias']
		res1_bn2_weight = model_dict['res1.bn2.weight']
		res1_bn2_bias = model_dict['res1.bn2.bias']
		res1_bn2_running_mean = model_dict['res1.bn2.running_mean']
		res1_bn2_running_var = model_dict['res1.bn2.running_var']

		res2_conv1_weight = model_dict['res2.conv1.weight']
		res2_conv1_bias = model_dict['res2.conv1.bias']
		res2_bn1_weight = model_dict['res2.bn1.weight']
		res2_bn1_bias = model_dict['res2.bn1.bias']
		res2_bn1_running_mean = model_dict['res2.bn1.running_mean']
		res2_bn1_running_var = model_dict['res2.bn1.running_var']
		res2_conv2_weight = model_dict['res2.conv2.weight']
		res2_conv2_bias = model_dict['res2.conv2.bias']
		res2_bn2_weight = model_dict['res2.bn2.weight']
		res2_bn2_bias = model_dict['res2.bn2.bias']
		res2_bn2_running_mean = model_dict['res2.bn2.running_mean']
		res2_bn2_running_var = model_dict['res2.bn2.running_var']

		res3_conv1_weight = model_dict['res3.conv1.weight']
		res3_conv1_bias = model_dict['res3.conv1.bias']
		res3_bn1_weight = model_dict['res3.bn1.weight']
		res3_bn1_bias = model_dict['res3.bn1.bias']
		res3_bn1_running_mean = model_dict['res3.bn1.running_mean']
		res3_bn1_running_var = model_dict['res3.bn1.running_var']
		res3_conv2_weight = model_dict['res3.conv2.weight']
		res3_conv2_bias = model_dict['res3.conv2.bias']
		res3_bn2_weight = model_dict['res3.bn2.weight']
		res3_bn2_bias = model_dict['res3.bn2.bias']
		res3_bn2_running_mean = model_dict['res3.bn2.running_mean']
		res3_bn2_running_var = model_dict['res3.bn2.running_var']

		res4_conv1_weight = model_dict['res4.conv1.weight']
		res4_conv1_bias = model_dict['res4.conv1.bias']
		res4_bn1_weight = model_dict['res4.bn1.weight']
		res4_bn1_bias = model_dict['res4.bn1.bias']
		res4_bn1_running_mean = model_dict['res4.bn1.running_mean']
		res4_bn1_running_var = model_dict['res4.bn1.running_var']
		res4_conv2_weight = model_dict['res4.conv2.weight']
		res4_conv2_bias = model_dict['res4.conv2.bias']
		res4_bn2_weight = model_dict['res4.bn2.weight']
		res4_bn2_bias = model_dict['res4.bn2.bias']
		res4_bn2_running_mean = model_dict['res4.bn2.running_mean']
		res4_bn2_running_var = model_dict['res4.bn2.running_var']

		res5_conv1_weight = model_dict['res5.conv1.weight']
		res5_conv1_bias = model_dict['res5.conv1.bias']
		res5_bn1_weight = model_dict['res5.bn1.weight']
		res5_bn1_bias = model_dict['res5.bn1.bias']
		res5_bn1_running_mean = model_dict['res5.bn1.running_mean']
		res5_bn1_running_var = model_dict['res5.bn1.running_var']
		res5_conv2_weight = model_dict['res5.conv2.weight']
		res5_conv2_bias = model_dict['res5.conv2.bias']
		res5_bn2_weight = model_dict['res5.bn2.weight']
		res5_bn2_bias = model_dict['res5.bn2.bias']
		res5_bn2_running_mean = model_dict['res5.bn2.running_mean']
		res5_bn2_running_var = model_dict['res5.bn2.running_var']

		conv4_weight = model_dict['conv4.weight']
		conv4_bias = model_dict['conv4.bias']
		bn4_weight = model_dict['bn4.weight']
		bn4_bias = model_dict['bn4.bias']
		bn4_running_mean = model_dict['bn4.running_mean']
		bn4_running_var = model_dict['bn4.running_var']

		conv5_weight = model_dict['conv5.weight']
		conv5_bias = model_dict['conv5.bias']
		bn5_weight = model_dict['bn5.weight']
		bn5_bias = model_dict['bn5.bias']
		bn5_running_mean = model_dict['bn5.running_mean']
		bn5_running_var = model_dict['bn5.running_var']

		conv6_weight = model_dict['conv6.weight']
		conv6_bias = model_dict['conv6.bias']

		pos_weight = model_dict['pos_output.weight']
		pos_bias = model_dict['pos_output.bias']
		cos_weight = model_dict['cos_output.weight']
		cos_bias = model_dict['cos_output.bias']
		sin_weight = model_dict['sin_output.weight']
		sin_bias = model_dict['sin_output.bias']
		width_weight = model_dict['width_output.weight']
		width_bias = model_dict['width_output.bias']
